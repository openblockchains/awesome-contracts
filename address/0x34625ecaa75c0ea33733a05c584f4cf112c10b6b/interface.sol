...
function addLayer(uint256 _layerIndex, (string,string,bytes,bool,uint256)[] traits /* struct Indelible.TraitDTO[] */);
function addTrait(uint256 _layerIndex, uint256 _traitIndex, (string,string,bytes,bool,uint256) trait /* struct Indelible.TraitDTO */);
...
function setContractData((string,string,string,string,string,uint256,string) _contractData /* struct Indelible.ContractData */);
...
function traitDetails(uint256 _layerIndex, uint256 _traitIndex) view  returns ((string,string) _ /* struct Indelible.Trait */);
